...
class ConfigDB(MongoDb):
    def __init__(self):
        ...
        self.grp_col = self.get_collection("groups")  
    ...
    async def update_group_settings(self, group_id, settings):
        await self.grp_col.update_one({'id': int(group_id)}, {'$set': {'settings': settings}})
